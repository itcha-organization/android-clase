...
El `Button` toma el parámetro `onClick`, que define la acción a ejecutar cuando el botón es presionado, y dentro de él se coloca el contenido que puede ser un texto o un ícono.
...
1. Extrae el archivo ZIP para crear una nueva carpeta dice_images que contenga seis archivos de imagen de dados con valores de dado del 1 al 6.
   ...
   ![image](https://github.com/user-attachments/assets/1f697b8c-14d2-4bce-bb17-d5c5ec521ce4)

   ![image](https://github.com/user-attachments/assets/d6b794f2-89ae-4fa2-a4d1-3938a28267f1)
...
1. Busca y selecciona la carpeta de seis imágenes de dados. Luego, súbelas.
   ![image](https://github.com/user-attachments/assets/0fc709b6-709f-49e6-bfe1-01720102b12b)
...
La descripción se complica considerablemente cuando hablamos de `by`, `remember` y `mutableStateOf` con más detalle.
